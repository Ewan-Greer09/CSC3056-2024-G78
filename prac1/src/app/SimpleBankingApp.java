...
public class SimpleBankingApp {
	...
	/**
	 * Calculate the balance of a given account (by its number). To do that, it
	 * needs to go over all transactions
	 * that match the account and get their sum total. For example, if an account
	 * has only two transactions in the
